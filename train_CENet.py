...
from lib.model_MyNet import MyNet
...
def train(train_loader, model, optimizer, epoch,save_path):
    ...
    for i, (images, gts, depths) in enumerate(train_loader, start=1):
        ...
        pre_res[0]=F.interpolate(pre_res[0], size=(256,256), mode='bilinear', align_corners=False)
        pre_res[1]=F.interpolate(pre_res[1], size=(256,256), mode='bilinear', align_corners=False)
        pre_res[2]=F.interpolate(pre_res[2], size=(256,256), mode='bilinear',align_corners=False)
        pre_res[3]=F.interpolate(pre_res[3], size=(256,256), mode='bilinear',align_corners=False)
