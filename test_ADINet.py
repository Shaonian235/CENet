...
model.load_state_dict(torch.load('./lib/RGBT.zip'))
model.eval()

#test
test_datasets = ['NJU2K','NLPR', 'SIP', 'DUT', 'STERE', 'LFSD', 'SSD',]
test_datasets = ['VT821','VT1000/VT1000', 'VT5000/Test']


for dataset in test_datasets:
    save_path = './RGBT/' + dataset + '/'
