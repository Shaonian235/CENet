...
class SwinTransformerV2(nn.Module):
    ...
    #              embed_dim=128, depths=[2, 2, 18, 2], num_heads=[4, 8, 16, 32],
    #              window_size=24, mlp_ratio=4., qkv_bias=True, qk_scale=None,
...
if __name__ == '__main__':
    ...
    swin.load_state_dict(torch.load('./swinv2_base_patch4_window12to24_192to384_22kto1k_ft.pth')['model'],strict=False)
